  ...
  return (
    <div className="absolute z-[5] text-[#fff] left-[1rem] top-[1rem] w-full">
        <Link to={'/'} className="flex items-center">
            ...
            <motion.span initial={{opacity:0,x:-50}} animate={{opacity:1,x:-5}} transition={{duration:2,delay:2,ease:'easeInOut'}}  style={{fontSize:'1.25rem'}} className="text-[#fff] relative top-[10px] pd-[0.5rem]">
                Wibe Studio
            </motion.span>
        </Link>
    </div>
